...
public interface CatServicePortType {
    ...
    /**
     * 
     * @param artistaRequest
     * @return
     *     returns net.tecgurus.catservice._1.ArtistaResponse
     */
    @WebMethod(action = "http://www.tecgurus.net/catService/artistaOperation")
    @WebResult(name = "artista_response", targetNamespace = "http://www.tecgurus.net/catService/1.0", partName = "artista_response")
    public ArtistaResponse artistaOperation(
        @WebParam(name = "artista_request", targetNamespace = "http://www.tecgurus.net/catService/1.0", partName = "artista_request")
        ArtistaRequest artistaRequest);
