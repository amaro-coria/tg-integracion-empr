...
public class GenericController {
	 ...
	 * @param params
	 */
	private void addMessage(FacesMessage.Severity severidad, String messageID, Object[] params) {
		FacesMessage message = new FacesMessage();
		message.setSeverity(severidad);
	...
	protected void addMesage(String messageSummary, String messageDetail) {
		getFacesContext().addMessage(null, new FacesMessage(messageSummary, messageDetail));
	}
