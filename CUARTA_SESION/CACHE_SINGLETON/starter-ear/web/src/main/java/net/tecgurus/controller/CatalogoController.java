...
import net.tecgurus.singleton.ClienteSingleton;
...
public class CatalogoController {
	...
	@EJB
	private ClienteSingleton singleton;
	...
	private void init() {
		...
		singleton.getClienteMap();//
	}

	public String onUpdate() {
		// TODO al elemento seleccionado settearle los campos string en caso de
		// que no sean nulos,
	...
	public String onCancel() {
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Se ha cancelado la accion correctamente"));
		return "";
	}
